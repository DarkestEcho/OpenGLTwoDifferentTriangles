...
int main()
{
	...
	const unsigned int fragmentShaderFirst = createShader(GL_FRAGMENT_SHADER, &fragmentShader1Source);
	const unsigned int fragmentShaderSecond = createShader(GL_FRAGMENT_SHADER, &fragmentShader2Source);

	// link shaders
	unsigned int shaders[] = { vertexShader, fragmentShaderFirst };
	const unsigned int shaderProgramFirst = createShaderProgram(shaders, 2);
	shaders[1] = fragmentShaderSecond;
	const unsigned int shaderProgramSecond = createShaderProgram(shaders, 2);

	deleteShaders(shaders);

	// vertex data and buffers
	// -----------------------
	constexpr float verticesFirstTriangle[] = {
		// first triangle
		-0.9f, -0.8f, 0.0f, // left
	...
	constexpr float verticesSecondTriangle[] = {
		0.0f, 0.4f, 0.0f, // left
	...
	bindVertexData(VBOs[0], VAOs[0], verticesFirstTriangle, sizeof(verticesFirstTriangle));
	bindVertexData(VBOs[1], VAOs[1], verticesSecondTriangle, sizeof(verticesSecondTriangle));
